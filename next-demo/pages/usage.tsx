...
const Usage: NextPage = () => {
  ...
  return (
    <div className="w-1/2 mx-auto mt-10 p-8 drop-shadow-lg border border-transparent text-base font-medium rounded-lg text-indigo-700 bg-gray-900 hover:bg-gray-800 md:text-lg">
      <Formly
        fields={fields}
        form_name={form_name}
        onSubmit={onSubmit}
